...
static unsigned char teletext[][9] = {
	...
	{ 10,10,31,10,31,10,10,0,0 },	// £		# in ASCII
	...
	{ 12,8,8,8,8,8,12,0,0 },	// [
	{ 0,16,8,4,2,1,0,0,0 },	// 1/2		\ in ASCII
	{ 6,2,2,2,2,2,6,0,0 },		// ]
	{ 4,10,17,0,0,0,0,0,0 },	// up arrow	^ in ASCII
	{ 0,0,0,0,0,0,31,0,0 },	// #		_ in ASCII
	{ 8,4,0,0,0,0,0,0,0 },		// dash		` in ASCII
	...
	{ 2,4,4,8,4,4,2,0,0 },		// 1/4		{ in ASCII
	{ 4,4,4,4,4,4,4,0,0 },	// ||		| in ASCII
	{ 8,4,4,2,4,4,8,0,0 },	// 3/4		} in ASCII
	{ 0,0,8,21,2,0,0,0,0 },		// divide sign	~ in ASCII
